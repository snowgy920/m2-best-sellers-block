...
class BestsellersList extends \Magento\Catalog\Block\Product\ListProduct {
    ...
    public function getProducts() {
        ...
        $dt_where = !empty($from) ? "AND order.created_at>='$from'" : "";
        $dt_where .= !empty($to) ? "AND order.created_at<='$to'" : "";
        ...
        $collection->getSelect()
            ...
            ->where("order.state <> 'canceled' and order.state <> 'new' and soi.parent_item_id IS NULL AND soi.product_id IS NOT NULL $dt_where")
